...
class CentroidTracker(ObjectTracker):
    ...
    def _algorithm(self):
        ...
        for frame_actual in range(1, len(self.sequence)):
            ...
            # Si no hay ningún objeto en el frame actual, pasar a la siguiente iteración.
            # TODO: Está mal, ya que se salta la fase de 'unregistering'.
            if len(objs_actual) == 0:
                continue
            # Si no hay ningún objeto registrado, saltar fase de emparjeamiento.
